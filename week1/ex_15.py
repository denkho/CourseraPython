...
# в положительном направлении по МКАД, если же значение v<0, то
# в отрицательном. (Гарантируется, что исходные числа —
# целые и находятся в промежутке от -1000 до +1000).
# Формат вывода
